  ...
  <div class="grid-x scroll-inline">
    <div class="g-card" v-for="movie in movies" :key="movie.id">
      <img
        ...
        class="imgx"
      />
      <p class="release-date">First Air Date: {{ movie.first_air_date }}</p>
...
export default {
  ...
  created() {
    let url ="https://api.themoviedb.org/3/tv/airing_today?api_key=18a017b1725a276ac9a9838ec5345147&language=en-US&page=1";
    fetch(url)
